...
var testFunc = function testFunc() {
  return {
    type: TEST_CREATOR,
    payload: axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('http://localhost:3001/api/test')
  };
};
...
function initializeStore() {
  return Object(external_redux_["createStore"])(testReducer["a" /* default */], Object(external_redux_["applyMiddleware"])(external_redux_promise_middleware_default.a));
}
