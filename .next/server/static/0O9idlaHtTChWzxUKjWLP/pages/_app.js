...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return testFunc; });
...
function testReducer() {
  ...
  switch (action.type) {
    case "".concat(TEST_CREATOR, "_FULFILLED"):
...
var testFunc = function testFunc() {
  return {
    type: TEST_CREATOR,
    payload: axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/api/test')
  };
};
/* harmony default export */ __webpack_exports__["a"] = (testReducer);
...
var external_redux_promise_middleware_ = __webpack_require__(13);
var external_redux_promise_middleware_default = /*#__PURE__*/__webpack_require__.n(external_redux_promise_middleware_);

// EXTERNAL MODULE: ./redux/reducers/testReducer.js
var testReducer = __webpack_require__(1);

// CONCATENATED MODULE: ./redux/store.js



var store = Object(external_redux_["createStore"])(testReducer["a" /* default */], Object(external_redux_["applyMiddleware"])(external_redux_promise_middleware_default()()));
...
function getOrCreateStore(initialState) {
  ...
  if (isServer) {
    return /* Cannot get final name for export "initializeStore" in "./redux/store.js" (known exports: default, known reexports: ) */ undefined(initialState);
  } // Create store if unavailable on the client and set it on the window object


  if (!window[__NEXT_REDUX_STORE__]) {
    window[__NEXT_REDUX_STORE__] = /* Cannot get final name for export "initializeStore" in "./redux/store.js" (known exports: default, known reexports: ) */ undefined(initialState);
  }
