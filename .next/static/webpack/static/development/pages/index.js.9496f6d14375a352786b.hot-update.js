...
function (_Component) {
  ...
  function CalendarComponent() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addImageBackground", function (elem) {
      elem[i].classList.add('calendar-bg');
  ...
  _createClass(CalendarComponent, [{
    ...
    value: function componentDidMount() {
      ...
      var _loop = function _loop(_i) {
        elems[_i].addEventListener('click', function () {
          _this2.addImageBackground(elems[_i]);
        });
      };

      for (var _i = 0; _i < iterationCount; _i++) {
        _loop(_i);
      }
    }
  }, {
...
//# sourceMappingURL=index.js.9496f6d14375a352786b.hot-update.js.map