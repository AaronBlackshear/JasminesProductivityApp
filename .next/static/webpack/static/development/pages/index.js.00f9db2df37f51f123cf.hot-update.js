...
function (_Component) {
  ...
  function CalendarComponent() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addImageBackground", function () {
      console.log("HIT");
    });
  ...
  _createClass(CalendarComponent, [{
    ...
    value: function componentDidMount() {
      ...
      for (var i = 0; i < iterationCount; i++) {
        elems[i].addEventListener('click', this.addImageBackground);
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.00f9db2df37f51f123cf.hot-update.js.map