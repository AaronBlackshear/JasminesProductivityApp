...
function (_Component) {
  ...
  function CalendarComponent() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addImageBackground", function (value) {
      var months = value.month(); // this.setState({ testMonths: months });
    });
  ...
  _createClass(CalendarComponent, [{
    ...
    value: function render() {
      // console.log("STATE: ", this.state.testMonths);
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        dateCellRender: this.addImageBackground,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 22
        },
...
//# sourceMappingURL=index.js.ebc17192d5643c4cb70e.hot-update.js.map